...
TEXT = {
    ...
    "fa": {
        ...
        "configuration": "پیکربندی", "smtp_settings": "تنظیمات SMTP", "smtp_hint": "اطلاعات اتصال و گیرندگان ایمیل", "smtp_host": "آدرس سرور SMTP",
        "smtp_port": "پورت SMTP","smtp_username": "نام کاربری SMTP", "smtp_password": "رمز عبور SMTP", "smtp_password_hint": "برای حفظ رمز فعلی خالی بگذارید",
        "smtp_from": "ایمیل فرستنده", "recipients": "گیرندگان ایمیل", "one_per_line": "هر ایمیل در یک خط", "use_tls": "استفاده از TLS",
        ...
        "full_name": "نام و نام خانوادگی", "telegram_username": "نام کاربری تلگرام", "telegram_id": "آی دی تلگرام", "mobile": "شماره موبایل",
        ...
        "blocked": "⛔ دسترسی  مسدود شده است.", "subject_first": "❗ ابتدا *موضوع ایمیل* را وارد کنید.", "unsupported": "❌ این نوع فایل پشتیبانی نمی‌شود.",
